                        ...
                        return Obx(
                          () => GestureDetector(
                            onTap: () {
                              ...
                              controller
                                  .applyFilter(controller.newCategories[index]);
                            },
                            child: Container(
                              width: 78.w,
                              height: 35.h,
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "Starts from \$${controller.products[index].coffeePrice.toString()}",
                                            style: GoogleFonts.poppins(
                                                fontSize: 10.sp,
                                                fontWeight: FontWeight.w400,
                                                color: whiteColor),
